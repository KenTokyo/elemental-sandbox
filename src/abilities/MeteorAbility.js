...
import { RibbonMode } from '../effects/RibbonGeometry.js';
...
import { MAX_CHUNKS, TRAIL_NODES, _emit, _pos, _dir, _heading, _impact } from './meteor-scratch.js';
import { meteorSetup } from './meteor-setup.js';
import { meteorFx } from './meteor-fx.js';
 ...
 * fast it cools are all resolved against `settings[element]` inside the update
...
export class MeteorAbility extends Ability {
  constructor(context, element = 'meteor') {
...
/**
 * Two halves of this engine live in `meteor-setup.js` and `meteor-fx.js`.
 *
 * MeteorAbility was past the 800-line rule in `AGENTS.md`. The bodies did not
 ...
 */
Object.assign(MeteorAbility.prototype, meteorSetup);
Object.assign(MeteorAbility.prototype, meteorFx);
