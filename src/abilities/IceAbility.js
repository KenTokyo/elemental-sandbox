 ...
 * is captured at spawn time; all of them are resolved against `settings[element]`
...
export class IceAbility extends Ability {
  constructor(context, element = 'ice') {
  ...
  createShaders() {
    ...
    this.material = createIceMaterial(environment, this.element);
