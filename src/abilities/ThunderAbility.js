 ...
 * every metre, radian and second against `settings[element]` each frame, on a
...
export class ThunderAbility extends Ability {
  constructor(context, element = 'thunder') {
  ...
  createShaders() {
    ...
    this.glowMaterial = createLightningMaterial(BoltPass.GLOW, this.element);
    this.coreMaterial = createLightningMaterial(BoltPass.CORE, this.element);
